...
export default function HeadingsIndexPage() {
  const categories = ["page", "card", "section"] as const;
  return (
    <>
      <PageHeader
        eyebrow="Headings"
        title="Headings"
        description="Reusable header treatments for full pages, cards, and inline sections. Compose them with metadata, tabs, breadcrumbs, and actions to anchor any layout."
      />
