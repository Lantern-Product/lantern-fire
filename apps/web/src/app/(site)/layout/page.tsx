  ...
  return (
    <>
      <PageHeader
        eyebrow="Layout"
        title="Layout"
        description="Composition primitives for arranging content: containers, cards, list containers, media objects, and dividers. Use these as the structural backbone of any page."
      />
